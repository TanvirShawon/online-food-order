        ...
        <div class="card-deck">
          <div class="card p-2 border-secondary mb-2">
            ...
            <div class="card-body p-1">
              ...
              <h5 class="card-text text-center text-danger" style="text-decoration: line-through;"><p>Tk.&nbsp;&nbsp;<?= number_format($row['price'],2) ?>/-</p></h5>
              <h5 class="card-text text-center text-danger"><p>Tk.&nbsp;&nbsp;<?= number_format($row['offerprice'],2) ?>/-</p></h5>
            </div>
            <div class="card-footer p-1">
              ...
              <form action="" class="form-submit">
                ...
                <input type="hidden" class="pprice" value="<?= $row['offerprice'] ?>">
