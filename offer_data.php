        ...
        <div class="container">
            ...
            if(!isset($_COOKIE["currentUser"])){
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <form class="" style="background:#DC4523" action="savedata_offer.php" method="post">
                    <h3 class="text-center">Input Offer Data </h3>
                    ...
                    <hr>
                        ...
                        <div class="form-group px-4">
                              <input type="text" name="price" value="" placeholder="Regular Price" class="form-control ">
                          </div>



                          <div class="form-group px-4">
                                <input type="text" name="offerprice" value="" placeholder="Offer Price" class="form-control ">
                            </div>
               ...
               <div class="col-md-8">
                  <table style="width:1000px;" class="text-center bg-light">
                    <tr>
                      ...
                      <td><b>Regular Price (Tk.)</b></td>
                      <td><b>Offer Price (Tk.)</b></td>
                      <td><b>Action</b></td>
                  ...
                  $sql = "SELECT id, food, avatar , price, offerprice, product_code FROM offer";
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    <tr>
                      ...
                      <td> <a onclick="return confirm('Are You Sure?');" href="deleteoffer.php?id=<?php echo $row["id"]; ?>">Delete</a>
                  </td>
