                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-sm-12 p-5">
                            <h3>BEWOO — Chinese restaurant</h3>
                            <p class="pcs">Unusual food combining the best of Asian cuisine. The very first bite provides a real explosion of flavours. In addition, an always smiling and energetic crew that will answer all of your questions.</p>
                            <h3 style="color: #DC4523; padding-top: 20px;"><i class="fas fa-phone-alt"></i> +8801991600124</h3>

                            <h3 style="color: #DC4523; padding-top: 20px;"><i class="fas fa-phone-alt"></i> +8801626380979 </h3>
                        </div>
                        <br><br>
                        <div class="col-lg-6 col-md-12 col-sm-12 p-5">
                            <img src="photo/contactlogo.png" alt="" class="cl">
                        </div>
                    </div>
